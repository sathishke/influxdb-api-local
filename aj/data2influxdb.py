# Command to insert the file into a influxdb database:
...
def loadCsv(inputfilename, servername, user, password, dbname, metric, 
    ...
    client = InfluxDBClient(192.168.1.8, 1883,test1, ssl=usessl)
    ...
    # open csv
    datapoints = []
    inputfile = open(Users/aj_heartnett/Downloads/smartphone_activity_dataset.csv, 'r')
    count = 0
