...
filePath = "/Users/aj_heartnett/PycharmProjects/Influxdb_py_main/"
csvFileName="collected_data.csv"
query="SELECT * FROM Ax WHERE time > now() - 5m"
#query="SELECT * FROM test1.autogen.Ax WHERE time > now() - 24h"
#query="SELECT * FROM test1.autogen.Ax WHERE time > now() - 24h"
rawDatahost="localhost"
rawDataport="8086"
rawDatabase="test1"
#influxClientPath="E:\influxdb-1.7.10-1"
influxClientPath="/Users/aj_heartnett/PycharmProjects/Influxdb_py_main/influxdb-1.7.10-1/usr/bin"
